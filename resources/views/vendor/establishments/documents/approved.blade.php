    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <h2 class="mb-0 fw-bold">Documentos Aprovados</h2>
            </div>
        </div>
    </div>
        ...
        <div class="card-body p-0">
            @if($approvedDocuments->isEmpty())
                <div class="empty-state text-center py-5">
                    ...
                    <h3 class="fw-bold mb-3">Nenhum documento aprovado</h3>
                    <p class="text-muted mb-4 col-md-8 mx-auto">Não há documentos aprovados para exibir no momento.</p>
                </div>
            @else
                        ...
                        <tbody>
                            @foreach($approvedDocuments as $document)
                                <tr>
                                    ...
                                    <td>{{ $document->approvedByUser->name ?? 'N/A' }}</td>
                                    <td>
