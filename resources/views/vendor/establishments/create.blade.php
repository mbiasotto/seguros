...
<head>
    ...
    <title>Novo Estabelecimento - Área do Vendedor</title>
            ...
            <div class="col-md-8">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('vendor.establishments.store') }}" method="POST">
                            @csrf
                            <div class="row g-3">
                                <div class="col-12">
                            ...
                            <div class="mt-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-check-lg"></i> Cadastrar Estabelecimento
                                </button>
                            </div>
                        </form>
                    </div>
