    ...
    <div class="login-container">
        <div class="login-image">
            <div class="login-image-content">
                <h2 style="font-size: 2.5rem; font-weight: 700;">Área do Vendedor</h2>
            </div>
        </div>
            ...
            <div class="form-container">
                ...
                <form method="POST" action="{{ route('vendor.password.update') }}">
                    ...
                    <div class="text-center text-muted small mt-4">
                        <p class="mb-0"><a href="{{ route('vendor.login') }}" class="form-text-link">Voltar para tela de login</a></p>
                    </div>
                </form>
            </div>
        </div>
