...
<body>
        ...
        <div class="auth-form-container">
            <div class="auth-form-wrapper">
                ...
                @php
                    ...
                    $cookieEmail = Cookie::get('establishment_remembered_email');
                @endphp
                ...
                <form method="POST" action="{{ route('establishment.login.submit') }}" class="auth-form">
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="mb-4 text-end">
                        <a href="{{ route('establishment.password.request') }}" class="auth-link">Esqueci minha senha</a>
                    </div>
                    ...
                    <div class="text-center text-muted small mt-4">
                        <p>Use o e-mail e senha fornecidos para acessar o sistema.</p>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script src="{{ asset('assets/admin/js/utils/auth-utils.js') }}"></script>
</body>
</html>
