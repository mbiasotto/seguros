...
<head>
    ...
    <title>Redefinir Senha - Minha Área</title>
    ...
    <div class="auth-container">
        ...
        <div class="auth-form-container">
            <div class="auth-form-wrapper">
                ...
                <form method="POST" action="{{ route('establishment.password.update') }}" class="auth-form">
                    @csrf
                    ...
                    <div class="text-center text-muted small mt-4">
                        <p class="mb-0"><a href="{{ route('establishment.login') }}" class="auth-link">Voltar para tela de login</a></p>
                    </div>
                </form>
            </div>
        </div>
