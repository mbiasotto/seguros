...
<head>
    ...
    <title>Recuperar Senha - Minha Área</title>
    ...
    <div class="auth-container">
        ...
        <div class="auth-form-container">
            <div class="auth-form-wrapper">
                ...
                <form method="POST" action="{{ route('establishment.password.email') }}" class="auth-form">
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="d-grid gap-3 mb-4">
                        ...
                        <a href="{{ route('establishment.login') }}" class="btn btn-secondary">
