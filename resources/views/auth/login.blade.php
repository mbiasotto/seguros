<!DOCTYPE html>
<!--
    Tela de Login - Área Administrativa
            ...
            <div class="login-form-wrapper">
                ...
                <form method="POST" action="{{ route('admin.login.submit') }}">
                    ...
                    <div class="mb-4 text-end">
                        <a href="{{ route('admin.password.request') }}" class="link-primary" style="color: var(--primary);">Esqueci minha senha</a>
                    </div>
                    ...
                    <div class="text-center text-muted">
                        <p>Acesso exclusivo para administradores<br>do sistema.</p>
                    </div>
                </form>
            </div>
        </div>
