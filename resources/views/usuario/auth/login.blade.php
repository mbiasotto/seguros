...
<head>
    ...
    <title>Login - Usuário | Multiplic</title>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card shadow-sm mt-5">
                    <div class="card-header bg-primary text-white text-center">
                        <h4><i class="fas fa-user"></i> Login Usuário</h4>
                    </div>
                    <div class="card-body">
                        @if (session('error'))
                        ...
                        <form method="POST" action="{{ route('usuario.login') }}" id="loginForm">
                            @csrf
                        ...
                        <div class="text-center mt-3">
                            <small class="text-muted">
                                <i class="fas fa-shield-alt"></i> Sistema seguro com autenticação por CPF
                            </small>
                        </div>
                    </div>
                </div>
